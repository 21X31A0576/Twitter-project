...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="text">
        <h1><a href="#" class="style11">IDENTIFICATION OF SUICIDAL CONTENT IN TWITTER DATA FLUX</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2 class="style16">IDENTIFICATION OF SUICIDAL CONTENT IN TWITTER DATA FLUX</h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
